...
<div class="card pt-3">
    <div class="card-body">
      <h2 class="text-center">INPUT DATA KELAS</h2>
        <div class="table-responsive">
            <div class="card">
                <form action="{{ route('admin.data-sekolah.store') }}" method="POST">
                    @csrf
                    <div class="card-body">
                  ...
                  <div class="card-footer">
                    <a href="{{ route('admin.data-sekolah.datakelas') }}" class="btn btn-danger me-5">Batal</a>
